...
let i = -1;
function autoCard() {
  if (i >= cardGalleryUlLi.length / 4 - 1) i = -1;
  i++;
  const gap = bestProduct.offsetWidth + cardGalleryUlLi[1].offsetLeft - cardGalleryUlLi[0].offsetLeft - cardGalleryUlLi[0].offsetWidth;
  const goto = (-i * gap) + 'px';
